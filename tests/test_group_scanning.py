...
class TestGroupScanning:
    ...
    @pytest.mark.parametrize(
        "tc_index, expected_name, expected_group, expected_have_group",
        [
    ...
    def test_test_case_groups(
        self, test_cases, tc_index, expected_name, expected_group, expected_have_group
    ):
        """
    ...
    def test_group_transition_logic(self, test_cases):
        ...
        chassis_last = next(
            tc for tc in test_cases if tc.name == "TC_Chassis_Suspension"
        )
