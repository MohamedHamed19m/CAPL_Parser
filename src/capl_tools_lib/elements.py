...
class CAPLElement:
    def __init__(
        self, name: str, start_line: int, end_line: int, signature: Optional[str] = None
    ):
        self.name = name
...
class TestCase(CAPLElement):
    ...
    def to_dict(self) -> dict[str, Any]:
        d = super().to_dict()
        d.update({"description": self.description, "group": self.group_name})
        return d
...
class TestGroup(CAPLElement):
    ...
    def to_dict(self) -> dict[str, Any]:
        d = super().to_dict()
        d.update({"test_cases": self.test_cases})
        return d
...
class Handler(CAPLElement):
    def __init__(
        ...
        super().__init__(
            ...
            start_line,
            end_line,
            signature=signature or f"on {event_type} {condition}",
        )
    ...
    def to_dict(self) -> dict[str, Any]:
        d = super().to_dict()
        d.update({"event_type": self.event_type, "condition": self.condition})
        return d
...
class Function(CAPLElement):
    def __init__(
        ...
        super().__init__(
            ...
            start_line,
            end_line,
            signature=signature or f"{return_type} {name}({', '.join(parameters)})",
        )
    ...
    def to_dict(self) -> dict[str, Any]:
        d = super().to_dict()
        d.update({"return_type": self.return_type, "parameters": self.parameters})
        return d
...
class TestFunction(CAPLElement):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            start_line,
            end_line,
            signature=signature or f"testfunction {name}({', '.join(params)})",
        )
...
class CaplInclude(CAPLElement):
    ...
    def to_dict(self) -> dict[str, Any]:
        d = super().to_dict()
        d.update({"included_files": self.included_files})
        return d
